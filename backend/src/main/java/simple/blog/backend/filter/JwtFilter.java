...
public class JwtFilter extends OncePerRequestFilter {
	...
	private static final Set<String> EXCLUDE_URL_PATTERNS = Stream
			.of("/api/v1/auth/", "/api/v1/verification/", "/public/", "/api/v1/ws")
	...
	protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
		...
		try {
			String username = jwtUtil.extractUsername(accessToken); // throws 
